export const types = {
    ...
    USER_RESET_PASSWORD_CONFIRM_PHONE_REQUEST:
        'USER_RESET_PASSWORD_CONFIRM_PHONE_REQUEST',
    USER_RESET_PASSWORD_CONFIRM_PHONE_SUCCESS:
        'USER_RESET_PASSWORD_CONFIRM_PHONE_SUCCESS',
    USER_RESET_PASSWORD_CONFIRM_PHONE_FAIL:
        'USER_RESET_PASSWORD_CONFIRM_PHONE_FAIL',

    // UI
    PREPARE_TO_RESEND_SMS: 'PREPARE_TO_RESEND_SMS',
